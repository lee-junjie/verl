...
export VAL_ROLLOUT_N=${VAL_ROLLOUT_N:-32}
...
export ROUTING_REPLAY_MODE=${ROUTING_REPLAY_MODE:-R3}
export ENABLE_ROLLOUT_ROUTING_REPLAY=${ENABLE_ROLLOUT_ROUTING_REPLAY:-True}
...
export TMP_DIR=${TMP_DIR:-/mnt/3fs2/data/junjie.li/rl-parity-test/verl/tmp/justrl_moe_r3}
