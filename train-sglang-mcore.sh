...
export PROJECT_NAME=verl_justrl
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-verl_justrl_$(date +%Y%m%d_%H%M%S)_$$}
export VAL_ROLLOUT_N=${VAL_ROLLOUT_N:-32}
export TRAIN_TP=1
export INFER_TP=1
export CKPT_PATH=/mnt/3fs2/data/junjie.li/rl-parity-test/verl/checkpoints
export TMP_DIR=/mnt/3fs2/data/junjie.li/rl-parity-test/verl/tmp/justrl
